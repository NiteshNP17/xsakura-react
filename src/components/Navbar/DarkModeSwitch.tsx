...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  "& .MuiSwitch-switchBase": {
    ...
    "&.Mui-checked": {
      ...
      "& + .MuiSwitch-track": {
        opacity: 1,
        backgroundColor: theme.palette.mode === "dark" ? "#8796A5" : "gray",
      },
    },
  },
  "& .MuiSwitch-thumb": {
...
const DarkModeSwitch: React.FC<DarkModeSwitchProps> = ({ toggleMode, mode }) => {
  return (
    <FormGroup style={{ marginLeft: "auto" }}>
      <FormControlLabel
        control={<MaterialUISwitch onChange={toggleMode} checked={mode === "dark"} />} label={undefined}      />
    </FormGroup>
  );
};
